...
export function buildStorybookPrompt(
  ...
  return [
    ...
    "FRONT-FACE PRIORITY: Keep the child's face visible to the viewer in a frontal or three-quarter angle. Do not stage the hero from behind, in silhouette, or with the face turned away.",
    ...
    "READABILITY RULE: If the text were hidden, a parent should immediately recognize their specific child as the protagonist experiencing the story events.",
    "PHOTO SAFETY RULE: The output should look like painted story art, not photorealistic reference usage, not a realistic photo, not a face swap, and not a studio portrait. Transform the photo into beautiful illustrated storybook character art while preserving the child's distinctive facial identity.",
