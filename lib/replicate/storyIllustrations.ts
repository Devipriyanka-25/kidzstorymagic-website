...
export function buildStorybookPrompt(
  ...
  return [
    ...
    "COMPLIANCE CHECK: The output is wrong if the child's face is hidden, if the child is shown mainly from the back, if an uploaded shirt pattern reappears, or if the scene looks like a realistic wildlife photo.",
