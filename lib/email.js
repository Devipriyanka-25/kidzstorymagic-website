...
const DEFAULT_FROM_EMAIL = 'Kidz Story Magic <support@kidzstorymagic.org>';
...
export function isResendSandboxSender() {
  return getEmailFromAddress().toLowerCase().includes('resend.dev');
}
